...
<div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-4">
    <p class="text-sm font-semibold text-yellow-900 mb-2">🔗 Connection to Robert's Rules</p>
...
- Constitution Article IV: Meeting governance → Links to Robert's Rules
- Bylaws Article II: Voting procedures → Links to Robert's Rules voting section
- Officer positions: EVP as parliamentarian → Links to Robert's Rules chair duties
...
4. **Reference Tables:**
   ...
   - Check marks (✓) and X marks (✗) for quick understanding
