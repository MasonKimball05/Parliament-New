...
def initiate_pledges(request):
    ...
    related_tables = [
        ...
        ('src_announcementemaillog', 'sent_by_id'),
        ('src_usersession', 'user_id'),
        ('src_twofactorrequirement', 'user_id'),
        ('src_twofactorrequirement', 'set_by_id'),
        ('src_servicehourssubmission', 'user_id'),
        ('src_servicehourssubmission', 'reviewed_by_id'),
        ('src_serviceactivity', 'user_id'),
        ('src_servicehoursadjustment', 'user_id'),
        ('src_servicehoursadjustment', 'created_by_id'),
        ('src_servicememberexpectation', 'user_id'),
