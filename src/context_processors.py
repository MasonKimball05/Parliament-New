...
def _get_client_ip(request):
    ...
    v3.18.8: delegates instead of reimplementing. The inline version here
    ignored BEHIND_CLOUDFLARE and returned the Cloudflare edge — one of five
    such copies. See the note in models/activity.py for what that cost.
    """
