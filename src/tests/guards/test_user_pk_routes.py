...
class PledgeIdsInFixturesAreRealisticTests(SimpleTestCase):
    ...
    def test_the_education_fixture_uses_a_pledge_shaped_id(self):
        # v3.2x — the fixture (make_user/EducationFixtureMixin) moved out of
        # test_education_scoring_and_meetings.py into a shared _fixtures.py
        # once other education test modules needed to import it too.
        body = (
            Path(settings.BASE_DIR) / 'src' / 'tests' / 'education' / '_fixtures.py'
