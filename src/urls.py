...
from src.view.admin_v2 import (
    ...
    honeypot_logs, security_notifications_log, csp_violations, csp_violation_dismiss, audit_log,
...
urlpatterns = [
    ...
    path('officers/announcements/<int:announcement_id>/poll/qr/', manage_poll_qr, name='manage_poll_qr'),
    path('officers/announcements/<int:announcement_id>/poll/qr/image/', poll_qr_image, name='poll_qr_image'),
    path('officers/announcements/<int:announcement_id>/poll/qr/embed/generate/', generate_poll_qr_embed_link, name='generate_poll_qr_embed_link'),
    path('officers/announcements/<int:announcement_id>/poll/qr/embed/revoke/', revoke_poll_qr_embed_link, name='revoke_poll_qr_embed_link'),
